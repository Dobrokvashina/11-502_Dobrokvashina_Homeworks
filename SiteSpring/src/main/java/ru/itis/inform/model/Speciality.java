...
public class Speciality {
    ...
    public Speciality(Long id, String name, List<Subject> subjects, String about) {
        this.id = id;
        this.name = name;
    ...
    public Speciality(Long id, University university, String name, String about) {
        this.id = id;
    ...
    public Speciality(Long id, String name, University university, List<Subject> subjects, String about) {
        this.id = id;
        this.university = university;
        this.name = name;
        this.subjects = subjects;
